...
class LuasBelahKetupat extends StatefulWidget {
  ...
  @override
  State<LuasBelahKetupat> createState() => _LuasBelahKetupatState();
}

class _LuasBelahKetupatState extends State<LuasBelahKetupat> {
  LuasBelahKetupats luasBelah = LuasBelahKetupats();
  final LuasBelahKetupats controller = LuasBelahKetupats();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                          ...
                          width: 100,
                          height: 100,
                          image: AssetImage("assets/Images/belahketupatrumus.png"),
                        )),
                      ),
                      Container(
                        width: 185,
                ...
                myTextField(controller.d1Controller, "Diagonal 1", false, TextInputType.number,),
                myTextField(controller.d2Controller, "Diagonal 2", false, TextInputType.number,),
                SizedBox(height: 20),
                Container(
                  height: 70,
                  width: 350,
                        ...
                        onPressed: () async {
                          ...
                          if (d1Text.isEmpty || d2Text.isEmpty) {
                            ...
                            if (d1 == 0.0 || d2 == 0.0) {
                              ...
                              await luasBelah.addData(d1, d2);
                              setState(() {
                                hasilText.value =
                                    "Hasil luas Belah Ketupat dari Diagonal 1, " +
                                        luasBelah.d1Obx.value +
                                        " cm" +
                                        " dan Diagonal 2, " +
                                        luasBelah.d2Obx.value +
                                        " cm" +
                                        " adalah " +
                                        (double.tryParse(luasBelah.hasilLuasBelah.value) ?? 0.0).toStringAsFixed(2) +
                                        " cm²";
