...
class LuasSegitiga extends StatelessWidget {
  final LuasSegitigas controller = Get.put(LuasSegitigas());
                      ...
                      Container(
                        ...
                        child: Center(
                            child: Image(
                              width: 100,
                              height: 100,
                              image: AssetImage("assets/Images/segitigarumus.png"),
                            )),
                      ),
                      Container(
                        width: 185,
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          if (alasText.isEmpty || tinggiText.isEmpty) {
                            ...
                            if (alas == 0.0 || tinggi == 0.0) {
                              ...
                              await controller.addData(alas, tinggi);
                              controller.hasilText.value =
                                  "Hasil luas segitiga dari Alas, " +
                                      controller.alasObx.value +
                                      " cm" +
                                      " dan Tinggi, " +
                                      controller.tinggiObx.value +
                                      " cm" +
                                      " adalah " +
                                      (double.tryParse(controller
                                          .hasilLuasSegiti.value) ??
                                          0.0)
                                          .toStringAsFixed(2) +
                                      " cm²";
                        ...
                        style: ElevatedButton.styleFrom(
                          foregroundColor: Color(0xFF152744),
                          backgroundColor: Color(0xFF4BA3A3),
